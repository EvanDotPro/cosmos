...
class ZFDebug_Controller_Plugin_Debug_Plugin_Time extends Zend_Controller_Plugin_Abstract implements ZFDebug_Controller_Plugin_Debug_Plugin_Interface
{
    ...
    public function mark($name) {
        if (isset($this->_timer['user'][$name]))
            $this->_timer['user'][$name] = (microtime(true)-REQUEST_MICROTIME)*1000-$this->_timer['user'][$name];
        else
            $this->_timer['user'][$name] = (microtime(true)-REQUEST_MICROTIME)*1000;
    }
    ...
    public function preDispatch(Zend_Controller_Request_Abstract $request)
    {
        ...
        $this->_timer['preDispatch'] = (microtime(true)-REQUEST_MICROTIME)*1000;
    }
    ...
    {
        $this->_timer['postDispatch'] = (microtime(true)-REQUEST_MICROTIME)*1000;
    }
