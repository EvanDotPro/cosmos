...
//        $message->setStyle(Zend_Wildfire_Plugin_FirePhp::GROUP_START);
	    ...
	    $table = array("App Profiling ({$count} total)",
            $rows
        );
	...
	public static function _toHTML(){
		...
		$out = '<div id="profiler-section" style="z-index:10000;position:fixed;bottom:5px;left:5px;opacity:1;background:white;width:320px;padding:5px;border:2px solid #CCC;" onmouseover="this.style.opacity=1" onmouseout="this.style.opacity=1">';
